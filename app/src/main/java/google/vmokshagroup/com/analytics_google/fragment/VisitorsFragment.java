package google.vmokshagroup.com.analytics_google.fragment;
...
import google.vmokshagroup.com.analytics_google.api_call.IGoogleAnalyticsApi;
import google.vmokshagroup.com.analytics_google.MyAccountManager2;
import google.vmokshagroup.com.analytics_google.R;
import google.vmokshagroup.com.analytics_google.adapter.Visitors_CustomAdapter;
import google.vmokshagroup.com.analytics_google.activity.WebSitePage;
import google.vmokshagroup.com.analytics_google.activity.BaseLoginActivity;
import google.vmokshagroup.com.analytics_google.activity.MainDashboard;
...
//            if (Connectivity.isConnected(getActivity())) {
    ...
    public String Week(String token, String id, final String sdate, final String edate) {
        ...
        dimensions.add("ga:medium,ga:socialNetwork,ga:hasSocialSourceReferral");
  ...
  /*  // TODO: Rename method, update argument and hook method into UI event
    ...
    public String SEPres(String result, String Edate, int size) {
        int social_count, result_social_count = 0;
        ArrayList<String> social_count_array = new ArrayList<String>();
        social_count_array.clear();
        try {
...
//                    if (i == 0) {
                    if (String.valueOf(array.get(0)).contentEquals("(none)")) {
                        directArray.add(String.valueOf(array.get(3)));
                    } else if (String.valueOf(array.get(0)).contentEquals("organic")) {
                        organucArray.add(String.valueOf(array.get(3))); //changed on nov 30
                    } else if (String.valueOf(array.get(0)).contentEquals("referral") || String.valueOf(array.get(0)).contentEquals("social")) {
                        if (String.valueOf(array.get(1)).contentEquals("(not set)")) {
                            referralArray.add(String.valueOf(array.get(3)));
                        } else {
                            social_count = Integer.valueOf((String) array.get(3));
                            result_social_count = result_social_count + social_count;
                            //  social_count_array.add(String.valueOf(result_social_count));
//                            socialArray.add(0, String.valueOf(social_count_array.get(social_count_array.size() - 1)));
//                            socialArray.set(0, String.valueOf(social_count_array.get(social_count_array.size() - 1)));
                        }
...
*/
                ...
                socialArray.add(String.valueOf(result_social_count));
    ...
    public void week_month_custom_responsefilter(String result, String Edate, int size) {
        int social_sessioncount, final_socialsessioncount = 0;
        int social_newusercount, final_newusercount = 0;
        double final_bounceratecount=0.0;
        Float social_bounceratecount;
        try {
            JSONObject j = new JSONObject(result);
            // String result = j.getString("rows");
            int monthnum = Integer.parseInt(Edate.substring(5, 7));
        ...
        /*    if (sessionscount.contentEquals("0")) {
            ...
            if (j.has("rows")) {
                ...
                for (int i = 0; i < rows.length(); i++) {
                    ...
                    if (String.valueOf(array.get(0)).contentEquals("(none)")) {
                        directArray.add(String.valueOf(array.get(3)));
                        directPageviewsArray.add(String.valueOf(array.get(5)));
                        directBouncerateArray.add(String.valueOf(array.get(6)));
                        // facebookpageview_persessionArray.add(String.valueOf(array.get(4)));
                    } else if (String.valueOf(array.get(0)).contentEquals("organic")) {
                        organucArray.add(String.valueOf(array.get(3)));
                        oraganicPageviewsArray.add(String.valueOf(array.get(5)));
                        organicBouncerateArray.add(String.valueOf(array.get(6)));
                        ...
                        if (String.valueOf(array.get(1)).contentEquals("(not set)")) {
                            referralArray.add(String.valueOf(array.get(3)));
                            referralPageviewsArray.add(String.valueOf(array.get(5)));
                            referralBouncerateArray.add(String.valueOf(array.get(6)));
                        } else {
                          ...
                          /*  socialArray.add(String.valueOf(array.get(1)));
                            ...
                            social_sessioncount = Integer.valueOf((String) array.get(3));
                            final_socialsessioncount = final_socialsessioncount + social_sessioncount;

                            social_newusercount = Integer.valueOf((String) array.get(5));
                            final_newusercount = final_newusercount + social_newusercount;

                            social_bounceratecount = Float.valueOf((String) array.get(6));
                            final_bounceratecount = final_bounceratecount + social_bounceratecount;
              ...
              /*      if (i == 0) {
                ...
                socialArray.add(String.valueOf(final_socialsessioncount));
                socialPageviewsArray.add(String.valueOf(final_newusercount));
                socialBouncerateArray.add(String.valueOf(final_bounceratecount));
