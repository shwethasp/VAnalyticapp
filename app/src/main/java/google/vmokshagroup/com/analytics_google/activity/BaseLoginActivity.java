package google.vmokshagroup.com.analytics_google.activity;
...
import google.vmokshagroup.com.analytics_google.BuildConfig;
import google.vmokshagroup.com.analytics_google.Connectivity;
...
import google.vmokshagroup.com.analytics_google.MyAccountManager2.MyAccountManagerListener;
import google.vmokshagroup.com.analytics_google.R;
import google.vmokshagroup.com.analytics_google.ScreenControllerV3;
...
public abstract class BaseLoginActivity extends AppCompatActivity implements OnItemClickListener, MyAccountManagerListener, AdapterView.OnItemSelectedListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private google.vmokshagroup.com.analytics_google.Account account;
    ...
    public static String id = "", resultentname = "", resultentid = "", resultentname1 = "", trackuniqueid = "", accountid = "";
    ...
    public static ArrayList arrayaccountid = new ArrayList();
    ...
    public static HashMap<String, String> NewHashmap = new HashMap<>();
              ...
              *//*  .client(okHttpClient)*//*
                    ...
                    try {
                        ...
                        for (int i = 0; i < items.length(); i++) {
                            ...
                            accountid = itemobj.getString("id");
              ...
              *//*  .client(okHttpClient)*//*
                                    .client(okHttpClient.newBuilder().connectTimeout(30, TimeUnit.SECONDS)
                                            .readTimeout(30, TimeUnit.SECONDS).writeTimeout(30,
                                                    TimeUnit.SECONDS).build())
                                    .build();
                            IGoogleAnalyticsApi mInterfaceService1 = retrofit1.create(IGoogleAnalyticsApi.class);
                            Call<JsonElement> mService2 = mInterfaceService1.getTimeZome(BASE_URL + "/analytics/v3/management/accounts/" + accountid + "/webproperties/"+ trackuniqueid +"/profiles?fields=items%2Ftimezone", "Bearer " + token);
                            mService2.enqueue(new Callback<JsonElement>() {
                                @Override
                                public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                                    String response_timeZone = response.body().toString();
                                    Log.d("response_timeZone", response_timeZone);
                            ...
                            for (int l = 0; l < webProperties.length(); l++) {
                                ...
                                trackuniqueid = webProperties01.getString("id");
                                Log.d("trackid",trackuniqueid);
//                                resnamesubList.add(resultentname1);
                                arrayListname1.add(resultentname1);
                                arrayListname2.add(trackuniqueid);
              ...
              *//*  .client(okHttpClient)*//*
                                    ...
                                    mService2.enqueue(new Callback<JsonElement>() {
                                        @Override
                                        public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                                            Log.e("res_timezone",String.valueOf(response.code()));
...
*/
                                ...
                                NewHashmap.put(trackuniqueid, resultentid);
