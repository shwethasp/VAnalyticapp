package google.vmokshagroup.com.analytics_google.adapter;
...
public class Website_CustomAdapter extends RecyclerView.Adapter<Website_CustomAdapter.DataObjectHolder> implements Filterable {
    ...
    public class DataObjectHolder extends RecyclerView.ViewHolder
            implements View
            .OnClickListener {
        TextView label, webtypename, timezone,tracking_id;
        ...
        public DataObjectHolder(View itemView) {
            ...
            tracking_id=(TextView)itemView.findViewById(R.id.tracking_id);
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        holder.tracking_id.setText("("+mArrayListModel.get(position).getTrackingid() +")");
